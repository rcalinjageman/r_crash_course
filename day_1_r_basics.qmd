...
You now have some experience running R code. We jumped in without details, but you made it through... though perhaps with some frustration?
...
We'll return to names again when we discuss code style in @sec-day-1-style
...
4.  Let's revisit an exercise from the @sec-ggsave. Run the following lines of code. Which of the two plots is saved as `mpg-plot.png`? Why?
...
Now that you've learned a little more about how R code works, and some tips to help you understand your code when you come back to it in the future. In the next chapter, we'll continue your data science journey by teaching you about coding style..
