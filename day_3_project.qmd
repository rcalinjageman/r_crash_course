...
Here is the poster template for the mini expo: [Workshop Poster Template](https://github.com/rcalinjageman/r_crash_course/raw/refs/heads/main/poster_template.pptx)
...
-   Databases of datasets:
    ...
    -   Best source: <https://www.nature.com/sdata/>  - this is a database of scientific datasets, each vetted and peer reviewed

    -   <https://openpsychologydata.metajnl.com/> - this is a journal in psychology devoted to open datasets

    -   APA list: <https://www.apa.org/research-practice/conduct-research/data-links>

    -   <https://datasetsearch.research.google.com/>

    -   <https://www.kaggle.com/datasets> - this is a decent resource, but be careful: some datasets are "synthetic" (fake); others are questionable or not well-documented.
